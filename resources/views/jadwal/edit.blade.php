...
<div class="row">
    <div class="col-12">
        <div class="card card-primary card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title"><b>Edit Jadwal</b></div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-control" name="mata_kuliah_id">
                          ...
                          <option value="{{ $item->id }}" {{ old('mata_kuliah_id') == $item->id ? 'selected' : ($jadwal->mata_kuliah_id == $item->id ? 'selected' : null) }}>
                            {{ $item->nama }}</option>
                          @endforeach </select>
